...
export const GetSeguros = (Jwt:string): Promise<DBConfiaCar_Catalogo.ISeguros_VW[]>=>
    new Promise((resolver: any, Denegar: any) => {
        axios.get<DBConfiaCar_Catalogo.ISeguros_VW>(`${GetServerUrl()}Seguros/getSeguros`,{
            headers: {
              'Authorization': `Bearer ${Jwt}`
            }
          })
            .then((res: AxiosResponse<DBConfiaCar_Catalogo.ISeguros_VW>) => {
                resolver(res);
